...
import { FiShoppingBag, FiTrash, FiEdit, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiShoppingCart } from 'react-icons/fi';
...
export const gridTaskImage = (props) => (
...
export const gridTaskStatus = (props) => (
  <button
    type="button"
...
//projects data
const gridProjectsProfile = (props) => (
  <div className="flex items-center gap-2">
    <p>{props.Name}</p>
  </div>
);
export const projectsData = [
  {
    projectID: 1,
    Name: 'Affiche Biat',
    Description: "Lorem Ipsum sat miat."
  },
  {
    projectID: 2,
    Name: 'Projet Fatal',
